...
export const mentors: MentorData[] = [
  ...
  },
  {
    ...
    mentoredPeople: [
      ...
      },
      {
        ...
        rating: 4.8,
        date: "Jul 2026",
        feedback: "Built a production-ready GraphQL authentication service under Charles's mentorship.",
      },
      {
        name: "Dina Farouk",
        type: "Consultation",
  ...
  },
  {
    ...
    featuredReview: {
      ...
      comment: "Outstanding mentor. XiLie taught me realistic web vulnerability testing and reporting.",
      rating: 5,
    },
    mentoredPeople: [
      {
      ...
      },
      {
        ...
        rating: 5,
        date: "Jun 2026",
        feedback: "XiLie's mentorship helped me land my first Junior Security Analyst job.",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    bio:
      "10+ years designing, automating, and maintaining enterprise infrastructure and hybrid cloud environments. Deep expertise in high availability, virtualization, Linux systems, network architecture, and Terraform automation.",
    tracks: ["platform-engineer", "devops-engineer"],
    skills: [
    ...
    menteesCount: 31,
    consultationHours: 160,
    responseRate: 99,
    attendanceRate: 100,
    availability: [
      { day: "Sunday", startTime: "18:00", endTime: "22:00" },
    ...
    mentoredPeople: [
      {
        ...
        type: "Consultation",
        topicOrTrack: "Infrastructure Automation & Terraform",
        rating: 5,
        date: "Aug 2026",
        feedback: "Migrated legacy on-prem infrastructure to automated Terraform modules with zero downtime.",
      },
      {
        name: "Hany Mansour",
        type: "Internship",
        topicOrTrack: "Enterprise Virtualization & VMware",
        rating: 5,
        date: "Jul 2026",
        feedback: "Mastered enterprise SAN storage setup and VMware ESXi cluster high availability.",
      },
      {
        name: "Mina Nader",
        type: "Consultation",
        topicOrTrack: "DevOps & Infrastructure",
        rating: 4.9,
        date: "Jun 2026",
        feedback: "Hands-on guidance through cloud network security and multi-VPC peering.",
      },
    ],
  },
  {
    id: "ahmed-moustafa",
    name: "Ahmed Moustafa",
    title: "Manager - Infrastructure & Platform Engineering",
    bio:
      "20+ years of engineering leadership and technical excellence across Infrastructure and Platform Engineering. Led large-scale enterprise cloud transformations, internal developer platforms (IDP), SRE practices, and multi-tier infrastructure teams.",
    tracks: ["platform-engineer", "devops-engineer"],
    skills: [
    ...
    rating: 5.0,
    reviewCount: 92,
    completedConsultations: 175,
    menteesCount: 45,
    consultationHours: 240,
    responseRate: 100,
    attendanceRate: 100,
    availability: [
    ...
    color: "bg-indigo-600",
    featuredReview: {
      userName: "Kareem F. (Senior Engineer)",
      comment: "Ahmed's leadership and deep platform architecture insights completely transformed our engineering velocity and infrastructure maturity.",
      rating: 5,
    },
    mentoredPeople: [
      {
        name: "Kareem Fahmy",
        type: "Consultation",
        topicOrTrack: "Platform Strategy & IDP Architecture",
        rating: 5,
        date: "Aug 2026",
        feedback: "Learned how to build Internal Developer Platforms that scaled our engineering org to 200+ devs.",
      },
      {
        name: "Sherif Ezzat",
        type: "Consultation",
        topicOrTrack: "Infrastructure Management & SRE",
        rating: 5,
        date: "Jul 2026",
        feedback: "Executive-level coaching on managing high-stakes cloud migrations and SLAs.",
      },
      {
        name: "Mariam Lotfy",
        type: "Internship",
        ...
        rating: 5,
        date: "Jun 2026",
        feedback: "Incredible mentorship on Kubernetes cluster fleet management and platform governance.",
      },
    ],
  },
  {
    ...
    bio:
      "Senior System Engineer specializing in enterprise systems engineering, Linux & Windows core administration, systems automation, performance tuning, and robust infrastructure monitoring.",
    tracks: ["devops-engineer", "platform-engineer"],
    skills: [
      "Systems Engineering",
      "Linux (RHEL/Ubuntu)",
    ...
    rating: 4.8,
    reviewCount: 48,
    completedConsultations: 78,
    menteesCount: 26,
    consultationHours: 115,
    responseRate: 98,
    attendanceRate: 99,
    availability: [
      { day: "Sunday", startTime: "17:00", endTime: "21:00" },
    ...
    color: "bg-violet-600",
    featuredReview: {
      userName: "Hassan B. (Consultation)",
      comment: "Ahmed solved our Linux kernel tuning and automated server patching pipeline in no time. Top-notch systems engineer!",
      rating: 5,
    },
    mentoredPeople: [
      {
        name: "Hassan Bakr",
        type: "Consultation",
        topicOrTrack: "Linux Systems Tuning & Patching",
        rating: 5,
        date: "Aug 2026",
        feedback: "Implemented Ansible playbooks for automated zero-downtime server updates.",
      },
      {
        name: "Yasmine Soliman",
        type: "Internship",
        topicOrTrack: "Systems Engineering Fundamentals",
        rating: 4.8,
        date: "Jul 2026",
        feedback: "Mastered core Linux troubleshooting, networking, and systemd service management.",
      },
      {
        name: "Bassem Adel",
        type: "Consultation",
        topicOrTrack: "Enterprise Monitoring & Alerting",
        rating: 5,
        date: "Jun 2026",
        feedback: "Set up end-to-end server metrics collection and automated alerting thresholds.",
      },
    ],
  },
];
